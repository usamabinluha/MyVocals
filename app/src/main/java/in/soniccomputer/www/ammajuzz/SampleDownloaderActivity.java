...
public class SampleDownloaderActivity extends Activity implements IDownloaderClient {
    ...
    private static final XAPKFile[] xAPKS = {
            new XAPKFile(
                    ...
                    // against
                    162323337L // the length of the file in bytes
            )/*,
            new XAPKFile(
            ...
            protected void onPostExecute(Boolean result) {
                if (result) {
                    ...
                    mPauseButton.setOnClickListener(new View.OnClickListener() {
                        @Override
                        public void onClick(View view) {
                            Intent mainIntent = new Intent("in.soniccomputer.www.ammajuzz.MAINACTIVITY");
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        int permission = ActivityCompat.checkSelfPermission(SampleDownloaderActivity.this, Manifest.permission.WRITE_EXTERNAL_STORAGE);
       ...
       // initializeDownloadUI();
        ...
        if (!expansionFilesDelivered()) {
            ...
            //Toast.makeText(this,"startApp",Toast.LENGTH_SHORT).show();
            Intent mainIntent = new Intent("in.soniccomputer.www.ammajuzz.MAINACTIVITY");
            startActivity(mainIntent);
            finish();
        }
